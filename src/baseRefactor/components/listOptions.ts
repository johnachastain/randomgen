...
export const naturalTuple: ListOptionTuple[] = [
  ['natural',             'Any Landform',       [Natural]],
  ['natural_mountain',    'Mountain',           [Natural]],
  ['natural_river',       'River',              [Natural]],
  ['natural_hills',       'Hill',               [Natural]],
  ['natural_desert',      'Desert',             [Natural]],
  ['natural_freshwater',  'Lakes/Rivers',       [Natural]],
  ['natural_highlands',   'Hills/Mountains',    [Natural]],
  ['natural_misc',        'Natural Misc.',      [Natural]],
  ['natural_woodlands',   'Forest',             [Natural]],
  ['natural_marshes',     'Swamp/Marshes',      [Natural]],
  ['natural_depression',  'Canyon/Valley/Gorge',[Natural]],
  ['natural_underground', 'Underground',        [Natural]],
  ['natural_saltwater',   'Ocean',              [Natural]],
  ['natural_stone',       'Stones/Rocks',       [Natural]],
]

export const constructionTuple: ListOptionTuple[] = [
  ['construction',               'Any Construction',    [Construction]],
  ['construction_fortification', 'Castles/Towers/Forts',[Construction]],
  ['construction_religious',     'Temples/Shrines',     [Construction]],
  ['construction_funerary',      'Crypts/Tombs',        [Construction]],
  ['construction_artifact',      'Artifacts',           [Construction]],
  ['construction_underground',   'Mines/Tunnels',       [Construction]],
  ['construction_shelter',       'Shelters',            [Construction]],
  ['construction_mechanical',    'Mechanical',          [Construction]],
  ['construction_security',      'Security',            [Construction]],
  ['construction_misc',          'Construction Misc.',  [Construction]],
  ['construction_freshwater',    'Wells',               [Construction]],
  ['construction_town',          'Towns',               [Construction]],
  ['construction_bridge',        'Bridge',              [Construction]],
  ['construction_tower',         'Tower',               [Construction]],
  ['construction_tavern',        'Inns/Taverns',        [Construction]],
  ['construction_city',          'Cities',              [Construction]],
]
